 ...
 */
//implements OnMapReadyCallback, View.OnClickListener,PermissionsListener
...
//            Log.e("CST","entro aca");
//            Call<infoDriver> statusTrip= ClienteRetrofit.getInstance().getApi().getStatusTrip(getViajeId(dataDriver));
...
//                    Call call= ClienteRetrofit.getInstance().getApi()
...
//                                Call comando= ClienteRetrofit.getInstance().getApi().puStatusTrip(getViajeId(dataDriver),false,true,false,false);
//                                comando.enqueue(new Callback() {
//                                    @Override
//                                    public void onResponse(Call call, Response response) {
//                                        if (response.isSuccessful()){
//                                            Log.e("errorFirebase",response.message());
//                                            Call llamada= ClienteRetrofit.getInstance().getApi()
...
//                    case 4:
//                        //getUserId(prefs)
//                        Call llamadaaaa= ClienteRetrofit.getInstance().getApi()
...
//                        break;
//                    case 6:
//                        Call<Driver> llamadaaaaa= ClienteRetrofit.getInstance().getApi()
...
//                                    septimo_estado();
//                                    Call comando= ClienteRetrofit.getInstance().getApi().puStatusTrip(getViajeId(dataDriver),false,true,true,false);
//                                    comando.enqueue(new Callback() {
//                                        @Override
//                                        public void onResponse(Call call, Response response) {
//                                            if (response.isSuccessful()){
...
//                    case 8:
//                        clearMessages();
//                        Call<Driver> pagoExitoso= ClienteRetrofit.getInstance().getApi()
...
//        Call comando= ClienteRetrofit.getInstance().getApi().puStatusTrip(getViajeId(dataDriver),false,true,true,true);
//        comando.enqueue(new Callback() {
//            @Override
//            public void onResponse(Call call, Response response) {
//                if (response.isSuccessful()){
...
//                        Call comando= ClienteRetrofit.getInstance().getApi().puStatusTrip(getViajeId(dataDriver),true,false,false,false);
//                        comando.enqueue(new Callback() {
//                            @Override
//                            public void onResponse(Call call, Response response) {
//                                if (response.isSuccessful()){
...
//        Call llamada= ClienteRetrofit.getInstance().getApi().driverTOuser(getDriverId_Prefs(prefs),
