package com.evans.technologies.conductor.common.shared

import android.content.Context
import android.content.SharedPreferences
import com.evans.technologies.conductor.app.MyApp
import com.evans.technologies.conductor.common.constants.Constants.APP_SETTINGS_TEMP
...
class SharedPreferencsTemp {
    companion object{
        ...
        fun getTempStringValue(key:String): String? =getSharedPreferencs().getString(key,"nulo")
